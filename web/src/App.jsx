      ...
      <div className="w-full bg-[url('./assets/bg.png')] max-w-7xl bg-no-repeat bg-cover h-[720px] overflow-hidden rounded-md m-auto relative">
        ...
        <div className='animate-slideUpScale absolute max-md:-right-12 right-0 top-0 z-30 flex flex-col'>
            ...
            <div className='absolute w-20 flex items-center flex-col max-md:right-9 right-4 max-md:top-16 top-10'>
              <img src={iconUser} alt="" className='cursor-pointer mb-16 max-md:w-10 max-md:mb-8' />
              <div className='flex flex-col gap-5'>
                <img src={avatar1} alt="" className='object-contain max-md:w-9 w-12 cursor-pointer' />
                <img src={avatar2} alt="" className='object-contain max-md:w-9 w-12 cursor-pointer' />
                <img src={avatar3} alt="" className='object-contain max-md:w-9 w-12 cursor-pointer' />
              </div>
            </div>
        </div>
        ...
        <div className='flex h-1/2'>
            <header className='p-4 w-full max-md:h-14 h-24 max-md:flex justify-center'>
              <img src={logo} alt="" className='object-contain animate-fadeIn'/>
            </header>
            <img src={name} alt="" className='animate-slideUpScale absolute max-md:w-60 max-md:-left-4 left-0 object-contain top-6' />
